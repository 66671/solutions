...
Del 2:
    ...
    have 2 parametre ved navn "string" og "repetition_list". "repetition_list" er en liste over integer tal.
        kald funktionen print_repeatedly() flere gange med hvert medlem af "repetition_list" som anden parameter.
        Den første parameter er altid "string".
...
def print_repeatedly(string, repitions):
    print(string*repitions, end="")

def print_pattern(string, repitition_list):
    for repitition_list_number in repitition_list: # "for hver nummer i repitition_list, gør det følgende:"
        print_repeatedly(string, repitition_list_number)
        print(" ", repitition_list_number)
